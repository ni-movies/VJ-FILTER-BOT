...
PICS = (environ.get('PICS', 'https://envs.sh/A-D.jpg')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://envs.sh/A-D.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "")
SPELL_IMG = environ.get("SPELL_IMG", "https://envs.sh/A-D.jpg")

# Admins, Channels & Users
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002316866795'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6899946963').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002434704210').split()]
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002386346176')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "Mongodb -  mongodb+srv://khalnayaknishant07:l89ZJpfFzJHQz7vA@cluster0.cq6mw.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Ni_backup') # Support Chat Link Without https:// or @
